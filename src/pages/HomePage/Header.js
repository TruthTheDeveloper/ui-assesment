    ...
    return(
        <header id="header" className="header__color">
            <section id="Navbar" className="navbar__style">
                <div>
                    <img src={logo} style={{ width:'6rem', padding:".5rem", marginTop: ".2rem"}}/>
                </div>
                <ul className="nav__link">
                    <li className="nav__link-list"><a>Product</a></li>
                    <li className="nav__link-list"><a>Service</a></li>
                    <li className="nav__link-list"><a>About</a></li>
            ...
            <section id="header__content">
                <div className="header__content-text">
                    <p className="header__text-1">We love to make great <br/> things, things that matter.</p>
                    <p className="header__text-2">Funding handshake buyer business to business metrics iPad partnership, first mover advantage</p>
                    <p className="header__text-2">innovator success deployment non disclosure</p>
                </div>
            </section>
